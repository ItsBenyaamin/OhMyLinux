...
local menu              = "$XDG_CONFIG_HOME/rofi/scripts/launcher_t7"
local powerMenu         = "$XDG_CONFIG_HOME/rofi/scripts/powermenu_t1"
local clipboardMenu     = "$XDG_CONFIG_HOME/rofi/scripts/clipboard_t1"
local screenShot        = "$XDG_CONFIG_HOME/helpers/screenshot.sh"
...
-- swap focused windows with arrow key
